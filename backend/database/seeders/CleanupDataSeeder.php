...
class CleanupDataSeeder extends Seeder
{
    public function run()
    {
        ...
        echo "Deleting teachers, principals, and student role users...\n";
        $deletedUsers = User::whereHas('roles', function($query) {
            $query->whereIn('name', ['Teacher', 'Principal', 'Student']);
        })->count();
        ...
        echo "Deleted {$deletedUsers} users (teachers/principals/students).\n\n";
