...
export default function PrincipalDashboard({ user }: { user?: User }) {
  ...
  return (
    <div className="space-y-6">
      {/* Page header */}
      <div>
        <h1 className="text-3xl font-bold text-white tracking-tight">{getGreeting()}, {user?.full_name || 'Principal'}</h1>
        <p className="text-gray-400 mt-1">
          Here's what needs your attention today, {new Date().toLocaleDateString('en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}
        </p>
      </div>
