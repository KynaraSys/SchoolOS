...
export function StudentForm({ onSuccess, initialData, studentId }: StudentFormProps) {
    ...
    const defaultValues = initialData ? {
        ...
        gender: initialData.student?.gender || undefined,
    ...
    return (
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                {/* Guardians Section */}
                <div className="space-y-4 rounded-lg border p-4 bg-white/40 dark:bg-white/5 backdrop-blur-md shadow-sm">
                    ...
                    <div className="space-y-3">
                        {guardians.map((guardian, index) => (
                            <div key={guardian.id || index} className="flex items-center justify-between p-3 bg-white/60 dark:bg-white/10 rounded-md border shadow-sm transition-all hover:bg-white/80 dark:hover:bg-white/20">
                                <div>
                                    ...
                                    <p className="text-xs text-muted-foreground">{guardian.relationship_type || 'Parent'} • {guardian.phone_number}</p>
                                </div>
                                <div className="flex items-center gap-2">
                                    {!guardian.is_primary && (
                                        <Button
